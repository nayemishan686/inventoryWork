...
"delete" => "Effacer",
"close" => "Fermer",
"something_went_wrong" => "Quelque chose c'est mal passé. Merci d'essayer plus tard si le problème perciste contactez nous (support@scalerp.com)",
...
"all" => "Tout",
"settings" => "Paramètres",
"business_location_settings" => "Paramètres du lieu d'entreprise",
"print" => "Impression",
"submit" => "Soumettre",
