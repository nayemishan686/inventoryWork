...
"pay_term" => "Délai de paiement pour les achats dans la période de temps donnée. <br/> <small class = 'text-muted'> Tous les paiements à venir ou en cours seront affichés dans le tableau de bord - Section Paiement dû </small>",
...
'shipping' => "Définissez les détails et les frais d'expédition. Cliquez sur l'icône d'édition ci-dessous pour ajouter/mettre à jour les détails et les frais d'expédition."
];
