...
return [
    ...
    */
    ...
    'langs' => [
        'ar' => ['full_name' => 'Arabic - العَرَبِيَّة', 'short_name' => 'Arabic','image'=>'/assets/flags/saudi-arabia.svg'],
        'en' => ['full_name' => 'English', 'short_name' => 'English','image'=>'/assets/flags/united-states.svg'],
        'es' => ['full_name' => 'Spanish - Español', 'short_name' => 'Spanish','image'=>'/assets/flags/spain.svg'],
        'fr' => ['full_name' => 'French - Français', 'short_name' => 'French','image'=>'/assets/flags/france.svg'],
        'de' => ['full_name' => 'German - Deutsch', 'short_name' => 'German','image'=>'/assets/flags/germany.svg'],
    ],
    'langs_rtl' => ['ar'],
