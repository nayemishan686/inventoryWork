LANG = {
    ...
    'cancel': 'إلغاء',
    'ok': 'موافق',
    'view_stock_details': 'عرض تفاصبل المخزون ',
    
    'tour_step1_title': 'كيف ابدأ في SCALERP',
    'tour_step1_content': 'دعنا نرى ما يمكنك القيام به باستخدام SCALERP في 7 خطوات سريعة ...' ,
    'tour_step2_title': 'الخطوة الأولى: تفاصيل عن عملك',
    'tour_step2_content':'قم بإعداد المعلومات الأساسية حول عملك',
    'tour_step3_title': 'الخطوة الثانية: إعدادات الشركة',
    'tour_step3_content': 'اضبط هنا جميع إعدادات عملك ، أضف مواقع نشاطك التجاري ، إعدادات الفواتير ، الضرائب ...',
    'tour_step4_title': 'الخطوة 3: الموردين و الزبائن(العملاء)',
    'tour_step4_content': 'هنا كل عملائك ومورديك ، يمكنك إنشاء وتعديل وتنظيم ... وحتى استيراد قوائم بسهولة',
    'tour_step5_title': 'الخطوة 4: المنتجات والمخزون',
    'tour_step5_content': 'أضف هنا منتجاتك البسيطة أو المتغيرة أو المركبة. <br> قم بإنشاء أشكال مختلفة من المنتجات والعلامات التجارية والفئات الخاصة بك <br> إدارة المخزون وطباعة الملصقات ...',
    'tour_step6_title': 'الخطوة 5: إدارة المشتريات',
    'tour_step6_content': 'هنا يمكنك إدارة المشتريات ومواعيد المدفوعات ... وكل ما يتماشى معها.',
    'tour_step7_title': 'الخطوة 6: إدارة المبيعات',
    'tour_step7_content': 'بيع -> نقاط البيع (POS) ، قم ببيع منتجاتك وإدارة الفواتير وعروض الأسعار لعملائك ، والتحكم بسهولة في كل شيء حتى التسليم',
    ...
    'register': 'تسجيل',
    'specify_business_name': "يرجى تحديد اسم مشروعك",
